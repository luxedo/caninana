...
class TestInit:
    ...
    def test_init_1(self):
        s = cn.Series(example_dict.values(), keys=example_dict.keys())
        assert dict(s) == example_dict

    def test_init_2(self):
        s = cn.Series(example_dict)
        assert dict(s) == example_dict

    def test_init_3(self):
        s = cn.Series(tuple(example_dict.values()))
    ...
    def test_init_5(self):
        s = cn.Series(example_dict, keys=example_dict.keys())
        assert dict(s) == example_dict
...
class TestStatistics:
    ...
    def test_statistics_other(self, func):
        sa = cn.Series(example_dict_a)
        sb = cn.Series(example_dict_b)
